...
bert_model = load_plm(path)#SentenceTransformer("multi-qa-mpnet-base-cos-v1", device="cuda")
...
def main():
    args = parse_args()
    #if args.use_proxy:
     #openai.proxy = "http://127.0.0.1:4780"  #7890
     #os.environ["ALL_PROXY"] = "http://127.0.0.1:4780"  #7890
